[![Travis Ci](https://img.shields.io/travis/andela-rekemezie/Document-Manager-REST-API/develop.svg)](https://travis-ci.org/andela-rekemezie/Document-Manager-REST-API)
